 ...
 */
function haguwa_custom_colors_css() {
	...
	/**
	 * Filter haguwa default saturation level.
	 *
	 * @since haguwa 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'haguwa_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter haguwa default selection saturation level.
	 *
	 * @since haguwa 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'haguwa_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter haguwa default lightness level.
	 *
	 * @since haguwa 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'haguwa_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter haguwa default hover lightness level.
	 *
	 * @since haguwa 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'haguwa_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter haguwa default selection lightness level.
	 *
	 * @since haguwa 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'haguwa_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters haguwa custom colors CSS.
	 *
	 * @since haguwa 1.0
	 *
	 ...
	 */
	return apply_filters( 'haguwa_custom_colors_css', $theme_css, $primary_color, $saturation );
}
